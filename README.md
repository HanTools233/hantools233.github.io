...
![如何IDlE新建Python文件.png](https://cdn.jsdelivr.net/gh/daizihan233/HanBot@main/img_1.png) <br>
将如下代码粘贴到IDLE里：
```Python
...
time.sleep(3)  # 等待三秒
```
![完成之后的样子](https://cdn.jsdelivr.net/gh/daizihan233/HanBot@main/img_2.png) <br>
然后按照你平时保存文件的方式走个流程<br>
![IDLE如何保存文件？①](https://cdn.jsdelivr.net/gh/daizihan233/HanBot@main/img_3.png) <br>
![IDLE如何保存文件？②](https://cdn.jsdelivr.net/gh/daizihan233/HanBot@main/img_4.png) <br>
